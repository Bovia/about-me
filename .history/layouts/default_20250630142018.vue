    ...
    <header class="header">
      <div class="header-content">
        ...
        <div class="social-links">
          <a href="https://github.com/zhandandan" target="_blank" class="social-link">GitHub</a>
          <a href="https://linkedin.com/in/dandanzhan" target="_blank" class="social-link">LinkedIn</a>
        </div>
      </div>
    </header>
    ...
    <footer class="footer">
      <div class="footer-content">
        <div class="footer-info">
          <p>&copy; {{ new Date().getFullYear() }} 詹丹丹 - 个人网站</p>
          <p>前端开发工程师 | 上海，中国</p>
        </div>
